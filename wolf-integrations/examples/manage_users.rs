...
use wolfsec::infrastructure::persistence::wolf_db_auth_repository::WolfDbAuthRepository;
use wolfsec::{AuthConfig, AuthManager, Permission, Role};
...
async fn main() -> anyhow::Result<()> {
    ...
    let storage = WolfDbStorage::open(db_path.to_str().unwrap())?;
