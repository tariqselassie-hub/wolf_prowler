use crate::identity::iam::{
    AuthenticationMethod, AuthenticationRequest, AuthenticationResult, ClientInfo, IAMConfig,
    Session, SessionRequest, SessionStatus, SessionValidationResult,
};
...
impl AuthenticationManager {
    ...
    pub async fn create_session(&self, user_id: Uuid, request: SessionRequest) -> Result<Session> {
        ...
        let session = Session {
            ...
            session_type: crate::identity::iam::SessionType::Regular,
            security_context: crate::identity::iam::session::SecurityContext {
                ip_changes: Vec::new(),
