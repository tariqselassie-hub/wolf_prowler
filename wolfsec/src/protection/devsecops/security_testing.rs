use crate::protection::devsecops::DevSecOpsConfig;
use anyhow::Result;
...
impl SecurityTestingManager {
    ...
    pub async fn run_test(
        &self,
        _test_config: &super::TestConfiguration,
    ) -> Result<super::TestResults> {
    ...
    pub async fn run_hunt_simulation(
        &self,
        _simulation: &super::HuntSimulation,
    ) -> Result<super::SimulationResults> {
