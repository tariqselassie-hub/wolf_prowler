...
impl SecurityMetrics {
    pub fn get(&self, key: &str) -> Option<&f64> {
        match key {
            "security_score" => Some(&self.derived_metrics.security_score),
            "performance_score" => Some(&self.derived_metrics.performance_score),
            "reliability_score" => Some(&self.derived_metrics.reliability_score),
            "efficiency_score" => Some(&self.derived_metrics.efficiency_score),
            "overall_health_score" => Some(&self.derived_metrics.overall_health_score),
            "compliance_score" => Some(&self.derived_metrics.compliance_score),
            _ => None,
        }
    }
}
